---
title: "Is SealMetrics GDPR, ePrivacy Regulation, CCPA, PECR,\u2026 compliant?"
...
SEAL is a European company, and our servers are located in Dublin.SEAL tracks ultimately anonymously and isolated page views (hits).SEAL doesn't insert any code in the user's terminal.
...
TimestampUser Agent (we don't store the user agent)Current URLReferral URL

Timestamp

Timestamp

User Agent (we don't store the user agent)
